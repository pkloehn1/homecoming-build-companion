...
def test_validate_tag_rejects_invalid(bad: str) -> None:
    """Test validate tag rejects invalid."""
...
def test_validate_sha_rejects_invalid(bad: str) -> None:
    """Test validate sha rejects invalid."""
    with pytest.raises(ValueError):
        _validate_sha(bad)
...
def test_create_tag_invalid_sha_from_api() -> None:
    """Test create tag invalid sha from api."""
    runner = QueueRunner(
        [
            ExpectedCall(
                argv=[
...
def test_create_tag_rejects_invalid_tag() -> None:
    """Test create tag rejects invalid tag."""
    runner = QueueRunner([])
...
def test_build_parser_returns_parser_with_expected_args() -> None:
    """Test build parser returns parser with expected args."""
